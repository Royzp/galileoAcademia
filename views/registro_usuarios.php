        ...
        <div class="content-wrapper">
            ...
            <div class="form-group col-md-12" style="overflow: hidden;overflow-y: auto;">
                ...
                <div class="form-group col-md-6" style="padding: 10px; float: left; width: 45%; text-align: justify;">
                    <img src="../views/dist/img/galileo5.jpg" style="width: 100%;height: 620px;">
                </div>




                <div class="form-group col-md-6" style="padding: 15px 35px; float: left; width: 50%; text-align: justify;">

                    <form method="Post" name="frm_admi" id="frm_admi">
                        <h1 style="font-size: 20px;font-weight: bold;text-transform: uppercase;">
                            Registro de Personal Galileo</h1>
                        <br>
