...
include_once 'conexion_bd/config_conexion.php';
 ...
 $busqueda = strtolower($_REQUEST['busqueda']);
  ...
  if (empty($busqueda)) {
      ...
      header("location: views/busqueda_documentos.php");
  }
...
/*  ====== PAGINADOR ===== */
 ...
 $sql_registe    = mysqli_query($conexion,'SELECT d.*, COUNT(*) AS total_registro FROM tb_documento as d where expediente LIKE '.$busqueda.' ');
...
WHERE expediente LIKE '.$busqueda.' 
ORDER by  d.id_document ASC  LIMIT '.$desde.', '.$por_pagina .' ' ;
