...
<style>
 ...
 <?php
   ...
   if(empty($busqueda)){
     ...
     header("location: lista_productos_ferreteria.php");
...
<table  class="table" >
 ...
 <?php
    ...
    $sql_registe = mysqli_query($conexion," SELECT COUNT(*) AS total_registro FROM  tb_producto 
   ...
   // echo $total_paginas;
    ...
    WHERE 
    ( pr.id_producto     LIKE '%$busqueda%' OR 
      pr.nombre_producto LIKE '%$busqueda%' OR 
      pr.marca           LIKE '%$busqueda%'  )
