...
<style>
   #tablaDate12 {
    ...
    #tablaDate12 thead tr {
        background-color:#393939  !important;
        color: #fff;
        border: none;
    }

    #tablaDate12 tbody tr {
        border: none;
    }

    #tablaDate12 tbody tr td {
        border: none;
        border-bottom: 1px solid #6B6B6C  ;
    }

     #tablaDate12 tr:hover{
...
font-weight: bold;
 ...
 TOTAL EXP. MINISTERIAL : <?php echo count($resultado)?>
<div class="container_print">
     <div class="scrollmenu">
   <table id="tablaDate12" class=" table table-responsive" border="1" style="width: 100%; display:table">
