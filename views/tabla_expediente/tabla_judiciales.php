...
<style>
   #tablaDate11 {
    ...
    #tablaDate11 thead tr {
        background-color:#393939  !important;
        color: #fff;
        border: none;
    }

    #tablaDate11 tbody tr {
        border: none;
    }

    #tablaDate11 tbody tr td {
        border: none;
        border-bottom: 1px solid #6B6B6C  ;
    }

     #tablaDate11 tr:hover{
...
font-weight: bold;
 ...
 TOTAL EXP. JUDICIALES : <?php echo count($resultado)?>
<div class="container_print">
     <div class="scrollmenu">
   <table id="tablaDate11" class=" table table-responsive" border="1" style="width: 100%; display:table">
