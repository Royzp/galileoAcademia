<?php
  ...
  $sql5 ="SELECT  d.*, a.nombre_user ,td.nombre_docum , ta.nombre_document , te.nombre_estado FROM  tb_documento as d 
...
font-weight: bold;
 ...
 TOTAL EXP. ARCHIVADO : <?php echo count($resultado5)?>
<div class="container_print">
     <div class="scrollmenu">
   <table id="tablaDate7" class=" table table-responsive" border="1" style="width: 100%; display:table">
   <!--<table id="tablaDate" class=" table table-responsive" border="1" style="max-width: 100%">-->
                    ...
                    <tbody >
                           ...
                           <?php if(!empty($resultado5)) { ?>
                        <?php foreach($resultado5 as $item) { ?>
                        ...
                        <tr style="font-size: 10px;">
                            ...
                            <td align="center"><?php echo $item['monto_cobrado']; ?></td>
                            <td align="center"><?php echo $item['fecha_archivado']; ?></td>
                            <td align="center"><?php echo $item['resolucion_archivado']; ?></td>
