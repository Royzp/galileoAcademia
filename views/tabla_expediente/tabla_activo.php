...
?>
 <style>
   #tablaDate25 {
    ...
    #tablaDate25 thead tr {
        background-color:#393939  !important;
        color: #fff;
        border: none;
    }

    #tablaDate25 tbody tr {
        border: none;
    }

    #tablaDate25 tbody tr td {
        border: none;
        border-bottom: 1px solid #6B6B6C  ;
    }

     #tablaDate25 tr:hover{
...
font-weight: bold;
 ...
 TOTAL EXP. ACTIVO : <?php echo count($resultado)?>
<div class="container_print">
     <div class="scrollmenu">
   <table id="tablaDate25" class=" table table-responsive" border="1" style="width: 100%; display:table">
