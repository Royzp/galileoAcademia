<?php
  ...
  $sql12 ="SELECT  d.*, a.nombre_user ,td.nombre_docum , ta.nombre_document ,te.nombre_estado  FROM  tb_documento as d 
  ...
  INNER JOIN tb_tipo_documento as td  on td.id_tip_docum = d.resolucion
   ...
   $sentencia12 = $pdo->prepare($sql12);
   $sentencia12 -> execute();
   $resultado12 = $sentencia12-> fetchAll();  
...
?>
 <style>
   #tablaDate27 {
    ...
    #tablaDate27 thead tr {
        background-color:#393939  !important;
        color: #fff;
        border: none;
    }

    #tablaDate27 tbody tr {
        border: none;
    }

    #tablaDate27 tbody tr td {
        border: none;
        border-bottom: 1px solid #6B6B6C  ;
    }

     #tablaDate27 tr:hover{
...
<div class="container_print">
   ...
   <table id="tablaDate27" class=" table table-responsive" border="1" style="width: 100%; display:table">
   <!--<table id="tablaDate" class=" table table-responsive" border="1" style="max-width: 100%">-->
                    ...
                    <tbody >
                           ...
                           <?php if(!empty($resultado12)) { ?>
                        <?php foreach($resultado12 as $item) { ?>
                        ...
                        <tr style="font-size: 10px;">
                            ...
                            <td align="center"><?php echo $item['resolucion_ejecucion']; ?></td>
