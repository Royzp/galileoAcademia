...
font-weight: bold;
 ...
 TOTAL EXP. OFICIO: <?php echo count($resultado)?>
<div class="container_print">
     <div class="scrollmenu">
   <table id="tablaDate3" class=" table table-responsive" border="1" style="width: 100%; display:table">
