...
font-weight: bold;
 ...
 TOTAL EXP. PREESCRITO : <?php echo count($resultado)?>
<div class="container_print">
     <div class="scrollmenu">
   <table id="tablaDate4" class=" table table-responsive" border="1" style="width: 100%; display:table">
