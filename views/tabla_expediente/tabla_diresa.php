...
font-weight: bold;
 ...
 TOTAL EXP. DIRESA : <?php echo count($resultado3)?>
<div class="container_print">
     <div class="scrollmenu">
   <table id="tablaDate9" class=" table table-responsive" border="1" style="width: 100%; display:table">
