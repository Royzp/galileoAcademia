...
<style>
   #tablaDate10 {
    ...
    #tablaDate10 thead tr {
        background-color:#393939  !important;
        color: #fff;
        border: none;
    }

    #tablaDate10 tbody tr {
        border: none;
    }

    #tablaDate10 tbody tr td {
        border: none;
        border-bottom: 1px solid #6B6B6C  ;
    }

     #tablaDate10 tr:hover{
...
font-weight: bold;
 ...
 TOTAL EXP. RR.HH : <?php echo count($resultado)?>
<div class="container_print">
     <div class="scrollmenu">
   <table id="tablaDate10" class=" table table-responsive" border="1" style="width: 100%; display:table">
