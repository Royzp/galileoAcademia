...
font-weight: bold;
 ...
 TOTAL EXP. BENEFICIO: <?php echo count($resultado)?>
<div class="container_print">
     <div class="scrollmenu">
   <table id="tablaDate6" class=" table table-responsive" border="1" style="width: 100%; display:table">
