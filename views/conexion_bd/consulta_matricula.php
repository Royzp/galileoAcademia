...
mysqli_query($conexion,"set names utf8");
    if(!empty($_POST['matricula_id'])){
        ...
        $query = mysqli_query($conexion,"SELECT m.*,
        p.tipo_documento_id,
        p.nombre,
        p.apellidos,
        p.numero_documento,
        p.direccion,
        p.celular_1,
        p.colegio_porcedencia,
        p.tipo_colegio,
        p.ano_egreso
        ,mo.nombre_modalidad,s.nombre_sede,pe.nombre_periodo,c.nombre_ciclo, tu.turno AS nombre_turno FROM tb_matricula AS m
